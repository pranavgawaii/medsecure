        ...
        <div className="flex h-screen w-full bg-background overflow-hidden">
            ...
            <div className="hidden lg:flex w-1/2 bg-primary relative items-center justify-center p-12 overflow-hidden">
                ...
                <div className="relative z-10 text-white max-w-lg">
                    ...
                    <h1 className="text-5xl font-bold mb-6 leading-tight">Secure Access for Medical Professionals.</h1>
                    <p className="text-xl text-blue-100 leading-relaxed">
                        Login to access real-time patient telemetry, manage ambulance fleets, and coordinate emergency response.
                    </p>
                </div>
            </div>
